...
### Variables ###
# Number of days the Root CA is valid for
...
# Ask for passwords
read -s -p "Enter the Root CA password: " ROOT_CA_PASSWORD
echo
...
read -s -p "Enter the Intermediate CA 1 password: " INTERMEDIATE_CA_1_PASSWORD
echo
